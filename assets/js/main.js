(function ($) {
  ...
  if ($(".tdmenu__wrap li.menu-item-has-children ul").length) {
    $(".tdmenu__wrap .navigation li.menu-item-has-children").append(
  ...
  if ($(".tdmobile__menu").length) {
    ...
    //Menu Toggle Btn
    $(".tdmobile__menu-backdrop, .tdmobile__menu .close-btn").on(
      "click",
      function () {
  ...
  /*=============================================
	...
	=============================================*/
  function makeTimer() {
    var endTime = new Date("30 april 2025 11:59:59 GMT+01:00");
  ...
  if ($("#productTabMarker").length > 0) {
    function td_tab_line_2() {
      ...
      var itemActive = document.querySelector(
        ".td-product-tab .nav-link.active"
      );
